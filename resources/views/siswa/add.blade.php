...
@section('content')
  ...
  NIS : <input type="text" name="nis" value="{{ old('nis') }}" required="">
  @if ($errors->has('nis')) {{ $errors->first('nis') }} @endif <br>
  Religion : <input type="text" name="agama" value="{{ old('agama') }}" required=""><br>
  Gender : <input type="text" name="jk" value="{{ old('jk') }}" required=""><br>
